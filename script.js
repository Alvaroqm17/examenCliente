...
campana2.style.cssText=" display: flex;position: absolute;height: 150px;width: 150px;margin-bottom: 90%;margin-left: 40%;display: flex;position: absolute;animation-name: rotate;animation-duration: 1.5s;animation-iteration-count: infinite;";
campana1.style.cssText="display: flex;position: absolute;height: 150px;width: 150px;margin-bottom: 90%;margin-right: 40%;display: flex;position: absolute;animation-name: spin;animation-duration: 1.5s;animation-iteration-count: infinite;";
